...
export const signRawTransaction = (transaction, privateKey) => {
  console.log('signRawTransaction, rawTransaction: ', transaction);
  console.log('signRawTransaction, privateKey: ', privateKey);
