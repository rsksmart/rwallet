...
const actions = {
  ...
  FETCH_LAST_BLOCK_HEIGHT: 'FETCH_LAST_BLOCK_HEIGHT',
  FETCH_LAST_BLOCK_HEIGHT_RESULT: 'FETCH_TLAST_BLOCK_HEIGHT_RESULT',
  ...
  START_FETCH_LAST_BLOCK_HEIGHT_TIMER: 'START_FETCH_LAST_BLOCK_HEIGHT_TIMER',
  ...
  startFetchLastBlockHeightTimer: () => ({
    type: actions.START_FETCH_LAST_BLOCK_HEIGHT_TIMER,
  }),
